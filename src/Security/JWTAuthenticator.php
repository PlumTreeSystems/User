...
class JWTAuthenticator extends AbstractGuardAuthenticator
{
    ...
    /*
     * @var $manager TokenManagerInterface
     */
    private $manager;
    ...
    {
        return new Response('Authentication is required', 401, ['WWW-Authenticate' => 'JWT']);
    }
    ...
    public function supports(Request $request)
    {
        ...
        if (!$this->manager->isValid($header[1])) {
            return false;
        }
        return true;
    }
    ...
    {
        if ($this->manager->isExpired($credentials)) {
